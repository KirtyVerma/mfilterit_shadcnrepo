...
const TEST_DATA = {
  ...
  creative_id: ["creative1", "creative2"],
  display_creative_url: "https://test.com/display-creative.jpg",
  capping_threshold: "1000",
  capping_timeframe: "daily",
  tp_tracker_type: ["tracker1", "tracker2"],
  tp_tracker_url: ["https://tracker1.com", "https://tracker2.com"],
...
const AddDisplayTracker: React.FC<AddDisplayTrackerProps> = ({ trackerType = "display_creative", inputType = "url" }) => {
  ...
  const initialFormValues: FormValues = {
    ...
    display_creative_url: TEST_DATA.display_creative_url,
  ...
  return (
    <Card className="p-6">
     <div className=" mb-8">
        <h1 className="ml-24 text-2xl font-semibold text-[#374151] mb-4 txt-center">Edit Display Tracker</h1>
              ...
              <div className="space-y-8">
                ...
                <div className="mt-6">
                  ...
                  <div className="relative" ref={creativeDropdownRef}>
                    <div
                      className="w-full min-h-11 px-3 py-2 bg-gray-50 border border-[#E5E7EB] rounded-md text-left flex flex-wrap gap-2 text-sm cursor-not-allowed opacity-50"
